...
import {
    ...
    updateTabPath,
    closeFolder,
} from "../assets/js/explorerTree/tabHandler.js";
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if ("app" in settings) {
        if ("devMode" in settings.app) {
            if (settings.app.devMode) {
                ...
                developerModeTopBar.content({
                    icon: "bug_report",
                    text: gls.get("devModeEnabled"),
                    type: "notification",
                });
                ...
                developerModeTopBar.on("hover", (instance) => {
                    instance.show();
                });
                developerModeTopBar.on("unhover", (instance) => {
    ...
    const yourOrganizationsPopupItem = document.querySelector(
        ".popup-content__item#yourOrganizations",
    );
