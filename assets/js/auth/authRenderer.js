...
export const submitBtn = document.querySelector(".form-submit");
export const usernameInput = document.querySelector("#username");
export const emailInput = document.querySelector("#email");
export const codeInput = document.querySelector("#code");
export const passwordInput = document.querySelector("#password");
export const confirmPassword = document.querySelector("#confirm_password");
export const errorBlock = document.querySelector(".user-form__error");
...
const submitBtnOriginText = submitBtn.textContent;
const loadingHtml = `
<l-line-spinner
    size="20"
    stroke="2"
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (document.querySelector("#alreadyHaveAccount"))
        document.querySelector("#alreadyHaveAccount").textContent = gls.get(
            "auth.alreadyHaveAnAccount",
        );
    if (document.querySelector("#howToRegisterOrg"))
        document.querySelector("#howToRegisterOrg").textContent = gls.get(
            "auth.howToRegOrganization",
        );
    if (document.querySelector("#registerNewAccount"))
        document.querySelector("#registerNewAccount").textContent =
            gls.get("auth.registerNewAccount");
    if (document.querySelector("#skipAccountCreation"))
        document.querySelector("#skipAccountCreation").textContent = gls.get(
            "auth.skipAccountCreation",
        );
    if (document.querySelector("#help"))
        document.querySelector("#help").textContent = gls.get("help");
