...
export function addRuntimeError({ msg, line = null, col = null, time = null, isNull = false, }) {
    const exists = runtimeErrors.some((error) => error.msg === msg && error.line === line && error.col === col);
